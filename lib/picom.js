...
function assignDefault(options, name, value) {
...
function Picom(serviceName, options) {
	...
	assignDefault(this.options, 'timeout', 30000);
	assignDefault(this.options, 'servers', ['nats://127.0.0.1:4222']);
...
Picom.prototype.request = function (methodName, message, options) {
	...
	return new Promise(function (resolve, reject) {
		const sid = nats.request(methodName, JSON.stringify(message), {max: 1}, function (responseString) {
